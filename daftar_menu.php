...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>URBAN KITCHEN</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link mr-4" href="utamaa.php" onclick="plh('HOME')">HOME</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="logout.php" onclick="plh('LOGOUT')">LOGOUT</a>
            </li>
          </ul>
        </div>
       </div> 
    ...
    <div class="row mt-3">
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/sate.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/croffle.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/rendang.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/empek-empek.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="row mt-3">
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/ayambetutu.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark ">
          <img src="images/sopbuntut.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/pecel.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/gadogado.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/gudeg.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/bikaambon.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/ayamtaliwang.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/ketoprak.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/cotomakasar.jpg" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/mieaceh.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/esteh.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/wedanguwuh.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/wedangjahe.jpg" class="card-img-top" alt="...">
          <div class="card-body">
     ...
     <div class="col-md-3 mt-4">
        <div class="card border-dark">
          <img src="images/mineral.jpg" class="card-img-top" alt="...">
          <div class="card-body">
